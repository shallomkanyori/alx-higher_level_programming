...
class TestRectangle(unittest.TestCase):
    ...
    def test_to_json_string_invalid_arguments(self):
        ...
        self.assertEqual(Rectangle.to_json_string("hello"), '"hello"')
        self.assertEqual(Rectangle.to_json_string((1, 2)), '[1, 2]')
        self.assertEqual(Rectangle.to_json_string({"1": 1, "2": 2}),
                         '{"1": 1, "2": 2}')
        self.assertEqual(Rectangle.to_json_string(1), '1')
        self.assertEqual(Rectangle.to_json_string(2.5), '2.5')
        self.assertEqual(Rectangle.to_json_string([1, 2, 3]), '[1, 2, 3]')
        self.assertEqual(Rectangle.to_json_string(["h", "e", "f"]),
                         '["h", "e", "f"]')

        self.assertRaises(TypeError, Rectangle.to_json_string, {1, 2, 3})
